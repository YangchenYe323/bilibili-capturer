...
const MessageParser = __nccwpck_require__(2632);
const RelaxedBody = __nccwpck_require__(7485);
const sign = __nccwpck_require__(6462);
...
const mimeFuncs = __nccwpck_require__(6128);
const crypto = __nccwpck_require__(6113);
...
const PassThrough = (__nccwpck_require__(2781).PassThrough);
const Cookies = __nccwpck_require__(8721);
...
const packageData = __nccwpck_require__(4129);
const shared = __nccwpck_require__(6225);
...
const MimeNode = __nccwpck_require__(515);
const mimeFuncs = __nccwpck_require__(6128);
...
const shared = __nccwpck_require__(6225);
const mimeTypes = __nccwpck_require__(260);
const MailComposer = __nccwpck_require__(612);
const DKIM = __nccwpck_require__(7791);
const httpProxyClient = __nccwpck_require__(2197);
const util = __nccwpck_require__(3837);
const urllib = __nccwpck_require__(7310);
const packageData = __nccwpck_require__(4129);
const MailMessage = __nccwpck_require__(5836);
...
const base64 = __nccwpck_require__(6852);
const qp = __nccwpck_require__(4967);
const mimeTypes = __nccwpck_require__(260);
...
const qp = __nccwpck_require__(4967);
const base64 = __nccwpck_require__(6852);
const addressparser = __nccwpck_require__(8627);
const fetch = __nccwpck_require__(7101);
const LastNewline = __nccwpck_require__(29);

const LeWindows = __nccwpck_require__(2143);
const LeUnix = __nccwpck_require__(3998);
...
const shared = __nccwpck_require__(6225);
const SMTPPool = __nccwpck_require__(7697);
const SMTPTransport = __nccwpck_require__(3240);
const SendmailTransport = __nccwpck_require__(9905);
const StreamTransport = __nccwpck_require__(1762);
const JSONTransport = __nccwpck_require__(4271);
const SESTransport = __nccwpck_require__(4057);
const fetch = __nccwpck_require__(7101);
const packageData = __nccwpck_require__(4129);
...
const os = __nccwpck_require__(2037);
const crypto = __nccwpck_require__(6113);
const DataStream = __nccwpck_require__(5101);
const PassThrough = (__nccwpck_require__(2781).PassThrough);
const shared = __nccwpck_require__(6225);
...
const EventEmitter = __nccwpck_require__(2361);
const PoolResource = __nccwpck_require__(564);
const SMTPConnection = __nccwpck_require__(666);
const wellKnown = __nccwpck_require__(8322);
const shared = __nccwpck_require__(6225);
const packageData = __nccwpck_require__(4129);
...
const SMTPConnection = __nccwpck_require__(666);
const assign = (__nccwpck_require__(6225).assign);
const XOAuth2 = __nccwpck_require__(6855);
const EventEmitter = __nccwpck_require__(2361);
...
module.exports = JSON.parse('{"_from":"nodemailer","_id":"nodemailer@6.7.3","_inBundle":false,"_integrity":"sha512-KUdDsspqx89sD4UUyUKzdlUOper3hRkDVkrKh/89G+d9WKsU5ox51NWS4tB1XR5dPUdR4SP0E3molyEfOvSa3g==","_location":"/nodemailer","_phantomChildren":{},"_requested":{"type":"tag","registry":true,"raw":"nodemailer","name":"nodemailer","escapedName":"nodemailer","rawSpec":"","saveSpec":null,"fetchSpec":"latest"},"_requiredBy":["#USER","/"],"_resolved":"https://registry.npmjs.org/nodemailer/-/nodemailer-6.7.3.tgz","_shasum":"b73f9a81b9c8fa8acb4ea14b608f5e725ea8e018","_spec":"nodemailer","_where":"/Users/yangchen/yycDev/bili-fans-checker","author":{"name":"Andris Reinman"},"bugs":{"url":"https://github.com/nodemailer/nodemailer/issues"},"bundleDependencies":false,"deprecated":false,"description":"Easy as cake e-mail sending from your Node.js applications","devDependencies":{"@aws-sdk/client-ses":"3.54.1","aws-sdk":"2.1096.0","bunyan":"1.8.15","chai":"4.3.6","eslint-config-nodemailer":"1.2.0","eslint-config-prettier":"8.5.0","grunt":"1.4.1","grunt-cli":"1.4.3","grunt-eslint":"24.0.0","grunt-mocha-test":"0.13.3","libbase64":"1.2.1","libmime":"5.0.0","libqp":"1.1.0","mocha":"9.2.2","nodemailer-ntlm-auth":"1.0.1","proxy":"1.0.2","proxy-test-server":"1.0.0","sinon":"13.0.1","smtp-server":"3.10.0"},"engines":{"node":">=6.0.0"},"homepage":"https://nodemailer.com/","keywords":["Nodemailer"],"license":"MIT","main":"lib/nodemailer.js","name":"nodemailer","repository":{"type":"git","url":"git+https://github.com/nodemailer/nodemailer.git"},"scripts":{"test":"grunt"},"version":"6.7.3"}');
...
(() => {
/* harmony import */ var node_fetch__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(8534);
/* harmony import */ var _actions_core__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(5127);
/* harmony import */ var nodemailer__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(2255);




const user_info_url = _actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput('api_url', { required: true })
const page_url = _actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput('page_url', { required: true })

const mid = _actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput('mid', { required: true })
const target = _actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput('target', { required: true })

// email configuration for sending
const user_email = _actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput('user_email', { required: true })
const user_pass = _actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput('user_pass', { required: true })

// email configuration for receiving
const receiver_email = _actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput('receiver_email', { required: true })

const fetch_follower = async () => {
	const response = await node_fetch__WEBPACK_IMPORTED_MODULE_0__(`${user_info_url}?mid=${mid}`);
